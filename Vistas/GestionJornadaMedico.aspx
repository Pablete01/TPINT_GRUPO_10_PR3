...
<asp:Panel ID="PanelAgregar" runat="server" Visible="false" CssClass="grid-container" Style="margin-top:20px;">
    ...
    <table style="width:100%;">
        ...
        <tr>
            <td>Hora Entrada:</td>
            <td><asp:TextBox ID="txtEntrada" runat="server" TextMode="Time"></asp:TextBox></td>
        </tr>

        <tr>
            <td>Hora Salida:</td>
            <td><asp:TextBox ID="txtSalida" runat="server" TextMode="Time"></asp:TextBox></td>
        </tr>

        <tr>
            <td>Duración (minutos):</td>
            <td><asp:TextBox ID="txtDuracion" runat="server" Text="60"></asp:TextBox></td>
        </tr>
    </table>
