...
<body>
    <form id="form1" runat="server">
        ...
        <div class="container" style="margin: 30px;">
            <asp:Label ID="lblTitulo" runat="server" Text="Informe General de Turnos" CssClass="section-title" Font-Size="40px" Font-Bold="True"></asp:Label>
            ...
            <div class="summary">
                ...
                <div class="summary-box">
                    ...
                    <asp:DropDownList ID="ddlControlFiltros" runat="server" Visible="False">
                        ...
                        <asp:ListItem Value="3">Reprogramado</asp:ListItem>
                        <asp:ListItem Value="4">Asistio</asp:ListItem>
                        <asp:ListItem Value="5">No Asistio</asp:ListItem>
                    </asp:DropDownList>
